...
export default class SalesTble extends React.Component {
    ...
    refreshList() {
        axios
            .get("https://onboardtaskaaron.azurewebsites.net/api/sales")
            .then((res) => {
                const data = res.data;
        ...
        fetch("https://onboardtaskaaron.azurewebsites.net/api/customers")
        ...
        fetch("https://onboardtaskaaron.azurewebsites.net/api/products")
            .then((response) => response.json())
        ...
        fetch("https://onboardtaskaaron.azurewebsites.net/api/stores")
            .then((response) => response.json())
    ...
    updateClick() {
        ...
        axios
            .put("https://onboardtaskaaron.azurewebsites.net/api/sales", {
    ...
    deleteClick(id) {
        ...
        axios
            .delete(
                "https://onboardtaskaaron.azurewebsites.net/api/sales/" + id
            )
            .then((res) => res.data)
            .then((res) => {
                this.refreshList();
    ...
    createClick() {
        ...
        axios
            .post("https://onboardtaskaaron.azurewebsites.net/api/sales", {
                Customer: this.state.Customer,
                Product: this.state.Product,
                Store: this.state.Store,
                DateSold: this.state.DateSold,
